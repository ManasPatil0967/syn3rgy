...
const FaqAccordion = () => {
	...
	const qna = [
...

		{
			...
			answer: <>Follow SIGAI on {<a className='underline' href='https://www.instagram.com/djs.sigai' target='_blank' rel="noopener noreferrer">Instagram</a>} for real-time updates and exciting announcements.</>,
		},
