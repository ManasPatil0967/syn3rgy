...
export default function Component() {
  return (
    <div className="flex flex-col min-h-[100dvh] items-center justify-center">
      ...
      <section id="title" className="border-t w-full py-12 md:py-24 lg:py-32 xl:py-48 items-center justify-center">
      ...
      <section id="about" className="border-t w-full py-12 md:py-24 lg:py-32">
        <div className="container flex flex-col items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
          <div className="space-y-3">
      ...
      <section id="timeline" className="border-t w-full py-12 md:py-24 lg:py-32 ">
      ...
      <section id="prizes" className="border-t w-full py-12 md:py-24 lg:py-32">
        <div className="container flex flex-col items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
          <div className="space-y-3">
      ...
      <section id="sponsors" className="border-t w-full py-12 md:py-24 lg:py-32">
